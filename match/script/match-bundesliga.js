$.ajax({
    ...
    type: "GET",
    url: "https://api.football-data.org/v2/competitions/2002/matches?matchday=1",
    dataType: "json",
    success: function (response) {
        
            $('.html-root-info').html(`
                <div class="image-league">
                <img src="../assets/bundesliga.png" alt="image league" class="img-league">
                </div>
...
function showData(){ 
    ...
    $.ajax({
        headers: { 'X-Auth-Token': 'c5fd253b8cc74963ad9baae1f724475a' },
        type: "GET",
        url: "https://api.football-data.org/v2/competitions/2002/matches?matchday="+ optionValue.value,
       dataType: "json",
        success: function (response) {
